...
def _launch_app():
    """Создать и запустить главное окно."""
...
def main():
    ...
    # Запустить bootstrap синхронно (быстро, так как пакеты уже установлены)
    print("[Система] Проверка зависимостей...")
    run_bootstrap(silent=True)
    print("[Система] Запуск интерфейса...")

    # Инициализация Discord RPC в фоновом потоке
